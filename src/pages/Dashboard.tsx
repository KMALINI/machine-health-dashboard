      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {cards.map((card) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-xl bg-secondary flex items-center justify-center ${card.accent}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <motion.div
            variants={item}
            className="industrial-card flex flex-col items-center justify-center lg:col-span-1"
          >
          ...
          <motion.div
            variants={item}
            className="industrial-card lg:col-span-1 flex flex-col items-center justify-center"
          >
          ...
          <motion.div variants={item} className="lg:col-span-1 industrial-card">
            ...
            <div className="space-y-3">
              {[
                {
                  msg: "Machine #12 - Bearing anomaly detected",
                  level: "critical" as const,
                  time: "2m ago",
                },
                {
                  msg: "Machine #07 - Vibration spike warning",
                  level: "warning" as const,
                  time: "15m ago",
                },
                {
                  msg: "Machine #03 - Returned to healthy",
