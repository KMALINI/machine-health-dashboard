  ...
  return (
    ...
    >
      ...
      <div className="px-2 pb-4 space-y-1 shrink-0">
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl w-full text-sidebar-foreground hover:bg-destructive/15 hover:text-destructive transition-colors">
